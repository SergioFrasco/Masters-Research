...
class DiscreteMiniWorldWrapper(OneRoom):
    ...
    def step(self, action):
        ...
        # Check collision with green sphere
        elif self.near(self.sphere_green):
        ...
        # Calculate distance to green sphere
        sphere_green_pos = self.sphere_green.pos
        distance_to_sphere_green = np.sqrt((agent_pos[0] - sphere_green_pos[0])**2 + (agent_pos[2] - sphere_green_pos[2])**2)
        ...
        # Calculate distance to green box
        box_green_pos = self.box_green.pos
        distance_to_box_green = np.sqrt((agent_pos[0] - box_green_pos[0])**2 + (agent_pos[2] - box_green_pos[2])**2)
        ...
        info['distance_to_box_green'] = distance_to_box_green
        info['distance_to_sphere_red'] = distance_to_sphere_red
        info['distance_to_sphere_blue'] = distance_to_sphere_blue
        info['distance_to_sphere_green'] = distance_to_sphere_green
        info['distance_to_goal'] = min(distance_to_box_red, distance_to_box_blue, distance_to_box_green,
                                        distance_to_sphere_red, distance_to_sphere_blue, distance_to_sphere_green)
    ...
    def _gen_world(self):
        ...
        self.sphere_green.radius = 0  # No collision during placement
        ...
        self.box_green.radius = 0  # No collision
