...
def train_successor_agent(agent, env, episodes = 4001, ae_model=None, max_steps=100, epsilon_start=1.0, epsilon_end=0.05, epsilon_decay=0.995, train_vision_threshold=0.1):
    """
